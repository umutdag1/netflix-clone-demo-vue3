<template>
  <template v-for="(hitem, i) in hArr" :key="i">
    <h1
      :class="hitem.class"
      :style="hitem.style"
      v-if="hitem.elemName === 'h1'"
      v-show="status"
      v-html="hitem.name"
    ></h1>
    <h2
